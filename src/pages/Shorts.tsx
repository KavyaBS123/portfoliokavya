      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid gap-8">
          {shorts.map((short, index) => (
            <article
              key={index}
              className="border border-black-900/30 rounded-xl p-8 hover:border-purple-400 transition-colors"
            >
              ...
              <p className="text-black-400 mb-6">{short.content}</p>
